...
def show_help():
    help_message = """
Usage: python tree.py -i aln_file -o output_dir -t threads

Options:
  -i    Input .aln file (amino acid alignment file)
  -o    Output directory for the result files
  -t    Number of threads to use for iqtree2
