...
"""
Using a set of phylogenetic markers, identify markers in protein sequences of target organisms.
Determine number of markers present in the target.
...
def main():
    ...
    parser.add_argument('--markerdb', required=True, help='HMM file of markers. Markers should have a descriptive ID name.')
    parser.add_argument('--performProdigal', action='store_true', help='Run Prodigal on input genome nucleotide FASTA file')
    ...
    for in_faa in input_proteins:
        ...
        with open(log_file, "w") as hmmer_log:
            if args.cut_tc:
                ...
                hmmsearch_cmd = ["hmmsearch", "-E", Evalue, "--tblout", tbl_file, "--notextw", markerdb, in_faa]
